...
<link rel="icon" href="<%=path%>/static/foc/index.ico" type="image/x-icon" />
				...
				<div class="am-tabs-bd">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-10">
									<input type="text" id="nickname" name="nickname"
										value="${user.nickname}" required placeholder="这里输入你的昵称...">
								</div>
							</div>
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-10">
									<input type="number" id="age" name="age" min="1" max="100"
										value="${user.age}" placeholder="这里输入你的年龄...">
								</div>
							</div>
							<div class="am-form-group">
					...
					<div class="am-tab-panel am-fade" id="tab3">
						<form class="am-form am-form-horizontal" data-am-validator
							action="${ctx}/${userid}/pass" method="post">
							<div class="am-form-group">
				...
				<div class="am-modal-bd  up-frame-body">
					...
					<div class="am-g am-fl">
						<div class="up-pre-before up-frame-radius">
							<img alt="" src="/chat/pic/${user.profilehead}" id="image">
						</div>
